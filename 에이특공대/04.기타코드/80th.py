...
model = Sequential()
model.add(Conv1D(filters=256, kernel_size=2, padding='same', input_shape=(6, 20)))
...
history = model.fit(x_train, y_train, epochs=3000, batch_size=512, validation_split=0.2, verbose=1, callbacks=[es,reduce_lr,cp])
