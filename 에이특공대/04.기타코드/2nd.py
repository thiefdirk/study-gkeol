...
es = EarlyStopping(monitor='val_loss', patience=40, mode='auto', verbose=1)
...
model.fit(x_train, y_train, epochs=200, batch_size=128, validation_split=0.2, verbose=1, callbacks=[es,reduce_lr])
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_epochs200.csv')

# loss: 0.0450 - mse: 0.0470
