...
model = MultiOutputRegressor(XGBRegressor(colsample_bytree= 0.9644368718752481, 
                                        #   learning_rate= 0.037971009986905564, 
                                          max_depth= int(6.526628539374641), 
                                          n_estimators= int(141.57411319983873), 
                                          max_leaves= int(82.11901576907334), 
                                        #   min_split_loss= 0.20773836593482728, 
                                        #   reg_lambda= 53.338801155512606, 
                                          subsample=0.8553449916749922))
...
pickle.dump(model, open('C:/Users/kogas/Desktop/ai_factory/_save/Model/pkl21_xgb.pkl', 'wb'))
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_21th_xgb.csv')
