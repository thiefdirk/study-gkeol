...
x = data.drop(columns=['PIA205B-02A_MIN', 'PIA205B-02A_MAX'])
y = data.loc[:,['PIA205B-02A_MIN', 'PIA205B-02A_MAX']]
test_sets = test_sets.drop(columns=['PIA205B-02A_MIN', 'PIA205B-02A_MAX'])
...
# model = MultiOutputRegressor(VotingRegressor(estimators=[('cat', cat), ('xgb', xgb), ('lgbm', lgbm)]))
...
pickle.dump(model, open('C:/Users/kogas/Desktop/ai_factory/_save/Model/pkl_15_vote_eval.pkl', 'wb'))
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_15th_vote_eval.csv')
