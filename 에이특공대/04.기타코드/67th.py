...
x = x.drop(['STN-MFR-S','LP_TOTAL', 'FI_SUM'], axis=1)   #독립변수
test_sets = test_sets.drop(['STN-MFR-S','LP_TOTAL', 'FI_SUM'], axis=1)
...
# model.load_model(f'C:/Users/kogas/Desktop/ai_factory/_save/Model/model_save_{try_num}__.pth')

from tensorflow.python.keras.callbacks import EarlyStopping, ModelCheckpoint, ReduceLROnPlateau

es = EarlyStopping(monitor='val_loss', patience=500, mode='min', verbose=1)
cp = ModelCheckpoint(monitor='val_loss', save_best_only=True, mode='auto', filepath=f'./_save/ModelCheckPoint/ai_fac_MCP{try_num}__.hdf5',verbose=1)
...
model.save(f'C:/Users/kogas/Desktop/ai_factory/_save/Model/model_save_{try_num}__.pth')


model.load_weights(f'./_save/ModelCheckPoint/ai_fac_MCP{try_num}__.hdf5')
...
submission.to_csv(f'C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_gap_{try_num}__th.csv')

submission.iloc[:, 0:] = gmp_predict

submission.to_csv(f'C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_gmp_{try_num}__th.csv')
