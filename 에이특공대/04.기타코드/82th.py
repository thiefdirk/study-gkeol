...
# x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.0, shuffle=True, random_state=66)
...
es = EarlyStopping(monitor='val_loss', patience=150, mode='min', verbose=1)
