...
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.8, shuffle=False, random_state=1234)

model = Sequential()
model.add(Conv1D(filters=128, kernel_size=2, padding='same', input_shape=(6, 15)))
...
model.fit(x_train, y_train, epochs=500, batch_size=256, validation_split=0.2, verbose=1, callbacks=[es,reduce_lr])
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_8th.csv')
