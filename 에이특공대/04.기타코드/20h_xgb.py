...
model = MultiOutputRegressor(XGBRegressor(colsample_bytree= 0.9644368718752481, 
                                        #   learning_rate= 0.037971009986905564, 
                                          max_depth= int(11.348392304957684), 
                                          n_estimators= int(529.3309389192068), 
                                          reg_alpha= 2.607264210232336, 
                                          min_split_loss= 0.20773836593482728, 
                                          reg_lambda= 53.338801155512606, 
                                          subsample=0.9255868667970283))
...
pickle.dump(model, open('C:/Users/kogas/Desktop/ai_factory/_save/Model/pkl20_xgb.pkl', 'wb'))
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_20th_xgb.csv')
