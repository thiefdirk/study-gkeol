...
x = data
x = data.drop(['ZIH120-02','STN-MFR-S','LP_TOTAL', 'PRESSURE-S', 'day'], axis=1)
test_sets = test_sets.drop(['ZIH120-02','STN-MFR-S','LP_TOTAL', 'PRESSURE-S', 'day'], axis=1)
...
model = Sequential()
model.add(Conv1D(filters=128, kernel_size=2, padding='same', input_shape=(6, 10)))
