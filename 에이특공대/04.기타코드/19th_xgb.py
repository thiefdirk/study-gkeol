...
model = MultiOutputRegressor(XGBRegressor(colsample_bytree= 0.5705535704090658, 
                                          learning_rate= 0.037971009986905564, 
                                          max_depth= int(9.274586370984544), 
                                          n_estimators= int(296.3675819802088), 
                                          reg_alpha= 26.01578163782181, 
                                          min_split_loss= 0.49019161466933825, 
                                          reg_lambda= 73.69818938987707, 
                                          subsample=0.8721682348188631))
...
pickle.dump(model, open('C:/Users/kogas/Desktop/ai_factory/_save/Model/pkl_19_xgb.pkl', 'wb'))
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_19th_xgb.csv')
