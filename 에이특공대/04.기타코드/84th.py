...
from tensorflow.keras.layers import BatchNormalization, Dense, LSTM, Dropout, Conv1D, Flatten, MaxPooling1D, GlobalAveragePooling1D,GlobalMaxPooling1D ,ReLU, LayerNormalization
