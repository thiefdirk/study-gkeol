...
data = data.drop(['TIME','TIME2'], axis=1, inplace=False)

test_sets = test_sets.drop(['TIME','TIME2'], axis=1, inplace=False)
...
ax = sns.heatmap(df_corr, annot=True, linewidth=.5, xticklabels=True, yticklabels=True)
