...
x = data
x = data.drop(['LP_TOTAL', 'STN-MFR-S'], axis=1)
test_sets = test_sets.drop(['LP_TOTAL', 'STN-MFR-S'], axis=1)
...
model.fit(x_train, y_train, epochs=400, batch_size=256, validation_split=0.2, verbose=1, callbacks=[es,reduce_lr])
