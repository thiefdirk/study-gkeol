...
x = data
x = data.drop(['STN-MFR-S','LP_TOTAL', 'PRESSURE-S','ZIH120-02'], axis=1)
test_sets = test_sets.drop(['STN-MFR-S','LP_TOTAL', 'PRESSURE-S','ZIH120-02'], axis=1)
...
model = Sequential()
model.add(Conv1D(filters=128, kernel_size=2, padding='same', input_shape=(6, 11)))
...
print('loss : ', round(loss,4))  #loss :  0.0128
