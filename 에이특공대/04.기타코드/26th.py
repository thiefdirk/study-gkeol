...
x = data
x = data.drop(['STN-MFR-S'], axis=1)
test_sets = test_sets.drop(['STN-MFR-S'], axis=1)
...
model = Sequential()
model.add(Conv1D(filters=128, kernel_size=2, padding='same', input_shape=(6, 14)))
...
print('loss : ', loss)  #loss :  0.016614487394690514
