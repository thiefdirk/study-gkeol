...
x = x.drop(['PRESSURE-S','FI_SUM', 'STN-MFR-S','LP_TOTAL' ], axis=1)   #독립변수
test_sets = test_sets.drop(['PRESSURE-S','FI_SUM','STN-MFR-S','LP_TOTAL'], axis=1)
...
history = model.fit(x_train, y_train, epochs=1500, batch_size=300, validation_split=0.2, verbose=1, callbacks=[es,reduce_lr,cp])
