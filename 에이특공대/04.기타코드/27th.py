...
x = data
x = data.drop(['STN-MFR-S','LP_TOTAL'], axis=1)
test_sets = test_sets.drop(['STN-MFR-S','LP_TOTAL'], axis=1)
...
model = Sequential()
model.add(Conv1D(filters=128, kernel_size=2, padding='same', input_shape=(6, 13)))
...
print('loss : ', round(loss,4))  #loss :  0.0141
