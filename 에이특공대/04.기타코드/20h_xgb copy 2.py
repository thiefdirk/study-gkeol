...
model = MultiOutputRegressor(XGBRegressor(colsample_bytree= 0.7431, 
                                        #   learning_rate= 0.037971009986905564, 
                                          max_depth= int(4.457), 
                                          n_estimators= int(330.7), 
                                          max_leaves= int(261.2), 
...
pickle.dump(model, open('C:/Users/kogas/Desktop/ai_factory/_save/Model/pkl22_xgb.pkl', 'wb'))
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_22th_xgb.csv')
