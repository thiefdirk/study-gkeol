...
model = MultiOutputRegressor(XGBRegressor(colsample_bytree= 0.9815247206589919, 
                                          learning_rate= 0.02826629552398998, 
                                          max_depth= int(11.017254661013832), 
                                          n_estimators= int(4680.363811723267), 
                                          reg_alpha= 82.95596208296719, 
                                          reg_lambda= 40.060612807214824, 
                                          subsample=0.7784064682044196))
...
pickle.dump(model, open('C:/Users/kogas/Desktop/ai_factory/_save/Model/pkl_16_xgb.pkl', 'wb'))
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_16th_xgb.csv')
