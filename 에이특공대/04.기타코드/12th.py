...
tpot = TPOTRegressor(verbosity=2, random_state=666, warm_start=True, scoring='neg_mean_absolute_error')
model = MultiOutputRegressor(tpot)



# model.fitted_pipeline_.fit(x_train, y_train)
model.fit(x_train, y_train)

# pickle.dump(model, open('C:/Users/kogas/Desktop/ai_factory/_save/Model/pkl_12_tpot.pkl', 'wb'))
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_12th_tpot.csv')
