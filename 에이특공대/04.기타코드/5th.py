...
model.fit(x_train, y_train, epochs=1000, batch_size=256, validation_split=0.2, verbose=1, callbacks=[es,reduce_lr])
...
submission.to_csv('C:/Users/kogas/Desktop/ai_factory/_data/dataset/submission_5th.csv')
