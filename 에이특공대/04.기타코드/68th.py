...
Conv1D_1 = Conv1D(filters=128, kernel_size=2, padding='same',activation='relu')(input_layer)
MaxP_1 = MaxPooling1D(pool_size=2)(Conv1D_1)
Conv1D_2 = Conv1D(filters=64, kernel_size=2, padding='same',activation='relu')(MaxP_1)
MaxP_2 = MaxPooling1D(pool_size=2)(Conv1D_2)
Conv1D_3 = Conv1D(filters=32, kernel_size=2, padding='same',activation='relu')(MaxP_2)
