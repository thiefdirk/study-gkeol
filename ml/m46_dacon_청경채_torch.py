...
all_input_list = sorted(glob.glob('C:\study\_data\dacon_chung/train_input/*.csv'))
all_target_list = sorted(glob.glob('C:\study\_data\dacon_chung/train_target/*.csv'))
...
test_input_list = sorted(glob.glob('C:\study\_data\dacon_chung/test_input/*.csv'))
test_target_list = sorted(glob.glob('C:\study\_data\dacon_chung/test_target/*.csv'))
...
import zipfile
os.chdir("C:\study\_data\dacon_chung/test_target/")
