...
print('최적 튠  R2 :',r2_score(y_test,y_predict))

print("걸린 시간 :",round(end,2),"초")

# 최적의 파라미터 : {'classifier__gamma': 0, 'classifier__learning_rate': 0.01,
# 'classifier__max_depth': None, 'classifier__min_child_weight': 100, 'classifier__n_estimators': 500}      
# best_score : 0.39826543175838375
# model_score : 0.5560908366835466
# r2_score : 0.5560908366835466
# 최적 튠  R2 : 0.5560908366835466
# 걸린 시간 : 5113.84 초