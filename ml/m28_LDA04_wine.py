...
# pca = PCA(n_components=1) # n_components : 주요하지 않은 변수를 제거하고 싶은 개수를 지정한다.
# x = pca.fit_transform(x) # x를 pca로 변환한다.
lda = LDA(n_components=2) # n_components : 주요하지 않은 변수를 제거하고 싶은 개수를 지정한다.
...
# load_wine
# model.score :  1.0
# model.fit 시간 :  0.04284548759460449

# load_wine PCA // n_components=1
# model.score :  0.75
# model.fit 시간 :  0.06755232810974121

# load_wine LDA // n_components=2
# model.score :  1.0
# model.fit 시간 :  0.06250214576721191
