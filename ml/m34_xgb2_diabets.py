...
pipeline = Pipeline([('scaler', MinMaxScaler()), ('classifier', XGBRegressor(random_state=123))], verbose=1)
...
# 최적의 파라미터 : {'classifier__gamma': 0, 'classifier__learning_rate': 0.3, 
#             'classifier__max_depth': 5, 'classifier__min_child_weight': 0.5, 'classifier__n_estimators': 100}
# 최적 튠  ACC : 0.4273318250683448

# 최적의 파라미터 : {'classifier__gamma': 0, 'classifier__learning_rate': 0.3, 
#             'classifier__max_depth': 6, 'classifier__min_child_weight': 1, 'classifier__n_estimators': 200}
# 최적 튠  ACC : 0.4608541186764704

# 최적의 파라미터 : {'classifier__gamma': 0, 'classifier__learning_rate': 0.1, 
#             'classifier__max_depth': 6, 'classifier__min_child_weight': 1, 'classifier__n_estimators': 300}
# 최적 튠  ACC : 0.49020259857358095

# 최적의 파라미터 : {'classifier__gamma': 0, 'classifier__learning_rate': 0.1, 
#             'classifier__max_depth': 2, 'classifier__min_child_weight': 1, 'classifier__n_estimators': 300}
# 최적 튠  ACC : 0.5666855362138158

# 최적의 파라미터 : {'classifier__gamma': 100, 'classifier__learning_rate': 0.1, 
#             'classifier__max_depth': 2, 'classifier__min_child_weight': 1, 'classifier__n_estimators': 300}
# 최적 튠  ACC : 0.5718655530683616
