...
model = Sequential()
model.add(Dense(300, input_dim=4, activation='linear')) #sigmoid : 이진분류일때 아웃풋에 activation = 'sigmoid' 라고 넣어줘서 아웃풋 값 범위를 0에서 1로 제한해줌
...
# cpu 걸린시간 :  6.200361013412476
# gpu 걸린시간 :  10.488252878189087