...
hist = model.fit([x1_train, x2_train, x3_train], y_train, epochs=1000, batch_size=100,
...
# loss :  [0.0014231682289391756, 0.03458251804113388]
# r2스코어 :  0.9999981992677942
# time : 49.28929042816162
