...
from tensorflow.python.keras.layers import Activation, Dense, Conv1D, Flatten, MaxPooling1D, Input, Dropout
...
hist = model.fit(x_train, y_train, epochs=20, batch_size=150,
...
# conv1d
# loss :  [0.4783695340156555, 0.8715000152587891]
# acc스코어 :  0.8715
# time : 31.589826822280884