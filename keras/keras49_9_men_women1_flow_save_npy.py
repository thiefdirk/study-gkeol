...
test_set1 = test_set_x.reshape((test_set_x.shape[0]), (test_set_x.shape[1])*(test_set_x.shape[2])*3)
...
test_set = test_set1.reshape(test_set_x.shape[0], test_set_x.shape[1], test_set_x.shape[2], 3)
...
np.save('d:/study_data/_save/_npy/keras49_9_train_x.npy', arr=xy_train[0][0])
np.save('d:/study_data/_save/_npy/keras49_9_train_y.npy', arr=xy_train[0][1])
