...
dense2 = Dense(10)(drp4)
batchnorm2 = BatchNormalization()(dense2)
activ2 = Activation('relu')(batchnorm2)
reshp1 = Reshape(target_shape=(10,1))(activ2)
conv1D_1 = Conv1D(10,3)(reshp1)
lstm_1 = LSTM(16)(conv1D_1)
dense3 = Dense(10)(lstm_1)
