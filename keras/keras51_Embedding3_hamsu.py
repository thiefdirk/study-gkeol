...
Embb = Embedding(input_dim=34, output_dim=20, input_length=5)(input1)
LSTM1 = LSTM(32, return_sequences=True, activation='tanh')(Embb)
LSTM2 = LSTM(32, return_sequences=True, activation='tanh')(LSTM1)
LSTM3 = LSTM(32)(LSTM2)
output1 = Dense(1, activation='sigmoid')(LSTM3)
...
model.fit(pad_x, labels, epochs=20, batch_size=128 ,validation_split=0.2,callbacks=[es])
