...
x_train = x_train.reshape(1094, 3, 3)
x_test = x_test.reshape(365, 3, 3)
...
flat = Flatten()(conv1d)
dense3 = Dense(100, activation='selu')(flat)
...
# conv1d
# loss :  [2142.318603515625, 32.48212432861328]
# RMSE :  46.28519135740458
# r2스코어 :  0.6943155276537468
# time : 65.18787169456482
