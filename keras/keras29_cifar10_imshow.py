...
conv2D_2 = Conv2D(200,2, padding='valid',
...
drp3 = Dropout(0.2)(activ1)
dense2 = Dense(100)(drp3)
batchnorm2 = BatchNormalization()(dense2)
activ2 = Activation('relu')(batchnorm2)
drp4 = Dropout(0.2)(activ2)
dense3 = Dense(100)(drp4)
batchnorm3 = BatchNormalization()(dense3)
activ3 = Activation('relu')(batchnorm3)
drp5 = Dropout(0.2)(activ3)
output1 = Dense(10, activation='softmax')(drp5)
...
# loss :  [1.1679327487945557, 0.5963000059127808]
# acc스코어 :  0.5963
