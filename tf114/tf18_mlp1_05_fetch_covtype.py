...
#hidden layer 1
w1 = tf.compat.v1.Variable(tf.random_normal([54,20], name='weight1'))
...
#output layer
w3 = tf.compat.v1.Variable(tf.random_normal([10,7], name='weight2'))
b3 = tf.compat.v1.Variable(tf.random_normal([7], name='bias2'))
